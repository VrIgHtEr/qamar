---@class simulation
---@field new_instruction_andi fun(circuit:simulation,name:string,opts:table|nil):simulation
...
return function(simulation)
	simulation:register_component(
		...
		function(s, f, opts)
			...
			s:cp(1, ctrl, "a", REGISTER_SELECT_WIDTH * 2 + 3, "VCC", "q", 1)
			s:cp(1, ctrl, "a", REGISTER_SELECT_WIDTH * 2 + 4, "GND", "q", 1)
		end
	)
end

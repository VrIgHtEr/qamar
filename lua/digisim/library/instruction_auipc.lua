---@class simulation
---@field new_instruction_auipc fun(circuit:simulation,name:string,opts:table|nil):simulation
...
return function(simulation)
	simulation:register_component(
		...
		function(s, f, opts)
			...
			local buf = f .. ".buf"
			s:new_tristate_buffer(buf, { width = 4 }):high(buf, "a", 1, 4):c(activated, "q", buf, "en")
			s

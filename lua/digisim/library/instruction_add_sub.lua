---@class simulation
---@field new_instruction_add_sub fun(circuit:simulation,name:string,opts:table|nil):simulation
...
return function(simulation)
	simulation:register_component(
		...
		function(s, f, opts)
			...
			local ctrl = f .. ".ctrl"
			s:new_tristate_buffer(ctrl, { width = REGISTER_SELECT_WIDTH * 3 + 3 })
			s:c(s0, "q", ctrl, "en")
